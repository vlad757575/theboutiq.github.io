 ...
 */
final class Version20220413102802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE historique_commande CHANGE date_commande date DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE historique_commande_commande (historique_commande_id INT NOT NULL, commande_id INT NOT NULL, INDEX IDX_F6BB8C4882EA2E54 (commande_id), INDEX IDX_F6BB8C485B442032 (historique_commande_id), PRIMARY KEY(historique_commande_id, commande_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE historique_commande CHANGE date date_commande DATE NOT NULL');
